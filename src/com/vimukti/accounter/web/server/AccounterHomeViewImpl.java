...
import com.vimukti.accounter.migration.AccounterMigrator;
...
public class AccounterHomeViewImpl extends AccounterRPCBaseServiceImpl
	...
	@Override
	public List<ConsultantsDetailsList> getConsultantItemsDetails() {
		List<ConsultantsDetailsList> consultantItems = new ArrayList<ConsultantsDetailsList>();
		try {
