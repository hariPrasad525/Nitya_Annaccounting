...
import com.vimukti.accounter.web.client.ui.grids.ConsultantListGrid;
import com.vimukti.accounter.web.client.ui.grids.ConsultantSelectionListener;
import com.vimukti.accounter.web.client.ui.grids.ConsultantTransactionsHistoryGrid;
...
//        }
    ...
    private void initItemsListGrid() {
        Accounter.createHomeService().getConsultantItemsDetails(
                new AsyncCallback<List<ConsultantsDetailsList>>() {

                    @Override
                    public void onSuccess(List<ConsultantsDetailsList> result) {
...
//            return TYPE_CUSTOMER_REFUND;
    ...
    public void addButtons(ButtonGroup group) {
        ...
        addInvoiceButton.addClickHandler(new ClickHandler() {
            ...
            @Override
            public void onClick(ClickEvent event) {
             ActionFactory.getNewInvoiceAction().runNewInvoiceView(selectedItem);
            }
        });
