...
public class InvoiceView extends AbstractCustomerTransactionView<ClientInvoice>
	...
	private void addControls() {
		...
		Label itemTableTitle = new Label(messages2.consultantName());
...
//			Window.alert("15");
	...
	protected void initTransactionViewData() {
		...
		if (transaction == null) {
			...
			if (customer != null) {
				...
				Window.alert(customer.getName());
				Window.alert(customer.getID()+"");
				customerTransactionTable.setPayee(customer);
			}
	...
	public  void selectedConsultantValue(ConsultantsDetailsList selectedItem)
	{
//		DomEvent.fireNativeEvent(Document.get().createChangeEvent(),jobListCombo);
//		StringComboBox<T> cBox= new StringComboBox<T>();
//		cBox.onRowSelect(selectedItem.getName(), true);
//		Window.alert(selectedItem.getName());
		updateNonEditableItems();
	}
