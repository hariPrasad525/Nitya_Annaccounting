...
public class InventoryAssemblyMigrator implements IMigrator<InventoryAssembly> {
	...
	public JSONObject migrate(InventoryAssembly item, MigratorContext context) throws JSONException {
		...
		external.put("com.vimukti.accounter.shared.inventory.InventoryAssembly", jsonObject);
		...
		String identity = "com.vimukti.accounter.shared.inventory.InventoryAssemblyItem";
		...
		for (InventoryAssemblyItem obj : components) {
			...
			jsonItemObj.put("com.vimukti.accounter.shared.inventory.InventoryAssemblyItem", jsonitem);
