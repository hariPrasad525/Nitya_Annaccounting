...
import com.vimukti.accounter.core.PayrollPayTax;
import com.vimukti.accounter.core.PayrollTransactionPayTax;
...
public class PayTaxMigrators extends TransactionMigrator<PayrollPayTax> {
	...
	public JSONObject migrate(PayrollPayTax obj, MigratorContext context) throws JSONException {
		...
		jsonObj.put("@class", "com.vimukti.accounter.shared.payroll.PayTax");
		...
		}
		{
			...
			for (PayrollTransactionPayTax item : transactionPayTax) {
				...
				jsonObject.put("@class", "com.vimukti.accounter.shared.payroll.PayTaxItem");
