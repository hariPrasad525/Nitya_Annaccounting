...
public class CompanyMigrator {
	public static final String ECGINE_URL = "http://vimukti.ecgine.com:80";
	...
	private static final String SIGNUP_CREATE_ORG = "/com.vimukti.ecgine.master/accounter/signup";
	...
	public static final String COMMON_SETTINGS = "com.vimukti.accounter.shared.common.CommonSettings";
	public static final String TDS_DEDUCTOR_MASTERS = "com.vimukti.accounter.shared.tax.TDSDeductorMasters";
	public static final String TDS_RESPONSIBLE_PERSON = "com.vimukti.accounter.shared.tax.TDSResponsiblePerson";
	public static final String FEATURES = "com.vimukti.accounter.shared.common.Features";
	public static final String CUSTOMER_AND_SALES_SETTINGS = "com.vimukti.accounter.shared.customer.CustomerAndSalesSettings";
	...
	private void prepareTaxRateCaluculations(Long ecgineTXNId,
		...
		object = taxCalculations
				.get("com.vimukti.accounter.shared.common.TaxCalculation");
	...
	private Long getTaxItemID(JSONObject jsonObject) throws JSONException {
		JSONObject taxItem = jsonObject.getJSONObject("taxItem").getJSONObject(
				"com.vimukti.accounter.shared.tax.TAXITem");
	...
	private void put(Long ecgineTXNId, JSONObject taxcalculation)
		...
		taxRateCalculation = taxRateCalculation
				.getJSONObject("com.vimukti.accounter.shared.common.TaxRateCalculation");
	...
	private void addCustomerAndVendorCreditsToContext(JSONObject jsonObject,
			...
			throws JSONException {
		if (jsonObject
				.has("com.vimukti.accounter.shared.customer.CustomerCredit")) {
			JSONObject creditObject = jsonObject
					.getJSONObject("com.vimukti.accounter.shared.customer.CustomerCredit");
			long customerCreditId = creditObject.getLong("id");
			context.put("CustomerCredit", customerCreditIds.get(index),
					customerCreditId);
		}
		if (jsonObject.has("com.vimukti.accounter.shared.vendor.VendorDebit")) {
			JSONObject debitObject = jsonObject
					.getJSONObject("com.vimukti.accounter.shared.vendor.VendorDebit");
