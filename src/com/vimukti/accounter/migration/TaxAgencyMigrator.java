...
public class TaxAgencyMigrator implements IMigrator<TAXAgency> {
	...
	public JSONObject migrate(TAXAgency obj, MigratorContext context) throws JSONException {
		...
		JSONObject external = new JSONObject();
		{
			...
			external.put("com.vimukti.accounter.shared.tax.TaxAgency", jsonObject);
		}
		...
		if (paymentTerm != null) {
			...
			purLiaAcc.put("com.vimukti.accounter.shared.common.PaymentTerm", json);
		...
		if (purchaseLiabilityAccount != null) {
			JSONObject purLiaAcc = new JSONObject();
			JSONObject json = new JSONObject();
			purLiaAcc.put("com.vimukti.accounter.shared.common.Account", json);
		...
		if (salesLiabilityAccount != null) {
			...
			JSONObject json = new JSONObject();
			salesLibAcc.put("com.vimukti.accounter.shared.common.Account", json);
		...
		if (filedLiabilityAccount != null) {
			...
			JSONObject json = new JSONObject();
			filedLiabibilyAccount.put("com.vimukti.accounter.shared.common.Account", json);
