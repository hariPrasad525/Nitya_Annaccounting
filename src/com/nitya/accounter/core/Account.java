...
public class Account extends CreatableObject implements IAccounterServerCore,
	...
	public boolean onUpdate(Session session) throws CallbackException {
			...
			if ((oldParent == null && parent == null)
				...
				if (parent != null) {
					...
					if (oldParent != null) {
						...
						// .createQuery(
						// "from com.nitya.accounter.core.Account a where a.parent=:parent and a.flow =:flow order by a.id")
		...
		// Object object =
		// session.createQuery(
		// "from com.nitya.accounter.core.TransactionMakeDepositEntries tme where tme.transaction.id=?"
		// ).setParameter(0,
	...
	public boolean canEdit(IAccounterServerCore clientObject,
		...
		// "from com.nitya.accounter.core.Account A where A.name=?")
