...
import com.nitya.accounter.web.client.ui.core.SpecialReference;
...
public abstract class Transaction extends CreatableObject implements
	...
	Set<ItemUpdate> itemUpdates = new HashSet<ItemUpdate>();
 	...
 	Set<EmployeeTimeSheet> empTimeSheet= new HashSet<EmployeeTimeSheet>();
	public Set<EmployeeTimeSheet> getEmpTimeSheet() {
		return empTimeSheet;
	}

	public void setEmpTimeSheet(Set<EmployeeTimeSheet> empTimeSheet) {
	...
	public Transaction clone() throws CloneNotSupportedException {
		...
		clone.setEmpTimeSheet(new HashSet<EmployeeTimeSheet>());
		return clone;
	}
