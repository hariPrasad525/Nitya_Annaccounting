...
public class ClientPaypalDetails {
	...
	private String PDTpaymentSstatus;
	private String charset;
	private String noptionSelection1;
	private String nmcFee;
	...
	public String getPDTpaymentSstatus() {
		return PDTpaymentSstatus;
	}

	public void setPDTpaymentSstatus(String pDTpaymentSstatus) {
		PDTpaymentSstatus = pDTpaymentSstatus;
	}
	...
	public String getNoptionSelection1() {
		return noptionSelection1;
	}

	public void setNoptionSelection1(String noptionSelection1) {
		this.noptionSelection1 = noptionSelection1;
	}

	public String getNmcFee() {
		return nmcFee;
	}

	public void setNmcFee(String nmcFee) {
		this.nmcFee = nmcFee;
	}
