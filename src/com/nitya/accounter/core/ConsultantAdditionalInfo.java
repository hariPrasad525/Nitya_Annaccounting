...
public class ConsultantAdditionalInfo extends CreatableObject implements IAccounterServerCore,
		INamedObject {
	...
	public ConsultantAdditionalInfo() {
	}
	...
	public boolean canEdit(IAccounterServerCore clientObject,
		...
		if (!UserUtils.canDoThis(ConsultantAdditionalInfo.class)) {
			throw new AccounterException(
					AccounterException.ERROR_DONT_HAVE_PERMISSION);
		}

		ConsultantAdditionalInfo itemGroup = (ConsultantAdditionalInfo) clientObject;
