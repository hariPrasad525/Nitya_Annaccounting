...
public class ClientTransactionItem implements IAccounterCore {
	...
	public ClientEmployeeTimeSheet getEmpTimeSheet() {
		return empTimeSheet;
	}

	public void setEmpTimeSheet(ClientEmployeeTimeSheet empTimeSheet) {
		this.empTimeSheet = empTimeSheet;
	}
	
	long employeeTimeSheetId;
	// ClientTAXItem taxItem;

	// private String taxitem;

	
	public long getEmployeeTimeSheetId() {
		return employeeTimeSheetId;
	}

	public void setEmployeeTimeSheetId(long employeeTimeSheetId) {
