...
import com.nitya.accounter.web.client.data.InvalidSessionException;
...
public interface IAccounterGETService extends RemoteService {
	...
	List<ClientInvoiceFrequencyGroup> getAllInvoiceFrequency() throws AccounterException;

	ClientInvoiceFrequencyGroup getInvoiceFrequency(long id) throws AccounterException;

	List<ClientEmployeeTimeSheet> getEmployeeTimeSheetValues(long fromDate, long toDate);
	
	ArrayList<ClientAttachment> getTimeSheetAttachments(long itemId);

	Boolean updateTimeSheetBilling(long empTimeSheet);

	ArrayList<ClientRewaHrTimeSheet> getRewaTimeSheet(long empId,Date fromDate, Date toDate);
