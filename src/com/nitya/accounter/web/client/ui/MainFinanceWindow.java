...
import com.nitya.accounter.web.client.imports.UploadCSVFileDialogAction;
import com.nitya.accounter.web.client.ui.banking.AccountRegisterAction;
import com.nitya.accounter.web.client.ui.banking.CreditCardChargeAction;
import com.nitya.accounter.web.client.ui.banking.MakeDepositAction;
import com.nitya.accounter.web.client.ui.banking.ReconciliationsListAction;
import com.nitya.accounter.web.client.ui.banking.WriteChecksAction;
import com.nitya.accounter.web.client.ui.company.BudgetAction;
import com.nitya.accounter.web.client.ui.company.ChalanListViewAction;
import com.nitya.accounter.web.client.ui.company.ChartOfAccountsAction;
import com.nitya.accounter.web.client.ui.company.CheckPrintSettingAction;
import com.nitya.accounter.web.client.ui.company.CompanyHomeAction;
import com.nitya.accounter.web.client.ui.company.CreateIRASInformationFileAction;
import com.nitya.accounter.web.client.ui.company.CreditRatingListAction;
import com.nitya.accounter.web.client.ui.company.CustomerCentreAction;
import com.nitya.accounter.web.client.ui.company.CustomersAction;
import com.nitya.accounter.web.client.ui.company.DeleteCompanyAction;
import com.nitya.accounter.web.client.ui.company.DepreciationAction;
import com.nitya.accounter.web.client.ui.company.HelpItem;
import com.nitya.accounter.web.client.ui.company.InventoryActions;
import com.nitya.accounter.web.client.ui.company.ItemsAction;
import com.nitya.accounter.web.client.ui.company.ManageFiscalYearAction;
import com.nitya.accounter.web.client.ui.company.ManageSupportListAction;
import com.nitya.accounter.web.client.ui.company.MergeAction;
import com.nitya.accounter.web.client.ui.company.NewAccountAction;
...
import com.nitya.accounter.web.client.ui.company.NewJournalEntryAction;
import com.nitya.accounter.web.client.ui.company.NewTAXAgencyAction;
import com.nitya.accounter.web.client.ui.company.PreferencesAction;
import com.nitya.accounter.web.client.ui.company.TDSResponsiblePersonAction;
import com.nitya.accounter.web.client.ui.company.TdsDeductorMasterAction;
import com.nitya.accounter.web.client.ui.company.UserDetailsAction;
import com.nitya.accounter.web.client.ui.company.UsersActivityListAction;
import com.nitya.accounter.web.client.ui.company.VendorCenterAction;
...
import com.nitya.accounter.web.client.ui.core.PayRollActions;
import com.nitya.accounter.web.client.ui.core.PayRollReportActions;
import com.nitya.accounter.web.client.ui.core.TransactionsCenterAction;
import com.nitya.accounter.web.client.ui.core.ViewManager;
import com.nitya.accounter.web.client.ui.customers.ConsultantCenterAction;
import com.nitya.accounter.web.client.ui.customers.CustomerPaymentsAction;
import com.nitya.accounter.web.client.ui.customers.CustomerRefundAction;
import com.nitya.accounter.web.client.ui.customers.CustomersHomeAction;
import com.nitya.accounter.web.client.ui.customers.EmployeeTimeSheetAction;
import com.nitya.accounter.web.client.ui.customers.InvoicesAction;
import com.nitya.accounter.web.client.ui.customers.NewCashSaleAction;
import com.nitya.accounter.web.client.ui.customers.NewConsultantCenterViewAction;
import com.nitya.accounter.web.client.ui.customers.NewCreditsAndRefundsAction;
import com.nitya.accounter.web.client.ui.customers.NewCustomerAction;
import com.nitya.accounter.web.client.ui.customers.NewInvoiceAction;
import com.nitya.accounter.web.client.ui.customers.NewJobAction;
import com.nitya.accounter.web.client.ui.customers.NewQuoteAction;
import com.nitya.accounter.web.client.ui.customers.ReceivePaymentAction;
import com.nitya.accounter.web.client.ui.customers.RecurringsListAction;
import com.nitya.accounter.web.client.ui.customers.SalesPersonAction;
import com.nitya.accounter.web.client.ui.fixedassets.PendingItemsListAction;
import com.nitya.accounter.web.client.ui.fixedassets.RegisteredItemsListAction;
import com.nitya.accounter.web.client.ui.fixedassets.SoldDisposedFixedAssetsListAction;
import com.nitya.accounter.web.client.ui.reports.BankingReportsAction;
import com.nitya.accounter.web.client.ui.reports.ClassAndLocationReportsAction;
import com.nitya.accounter.web.client.ui.reports.CompanyAndFinancialReportsAction;
import com.nitya.accounter.web.client.ui.reports.ECSalesListAction;
import com.nitya.accounter.web.client.ui.reports.InventoryDetailsAction;
import com.nitya.accounter.web.client.ui.reports.InventoryReportsAction;
import com.nitya.accounter.web.client.ui.reports.JobReportsAction;
import com.nitya.accounter.web.client.ui.reports.PayablesAndReceivablesReportsAction;
import com.nitya.accounter.web.client.ui.reports.PurchaseReportsAction;
import com.nitya.accounter.web.client.ui.reports.ReportsHomeAction;
import com.nitya.accounter.web.client.ui.reports.SalesReportsAction;
import com.nitya.accounter.web.client.ui.reports.TAXReportsAction;
import com.nitya.accounter.web.client.ui.reports.TransactionDetailByAccountAndCategoryAction;
import com.nitya.accounter.web.client.ui.reports.VAT100ReportAction;
import com.nitya.accounter.web.client.ui.reports.VATDetailsReportAction;
import com.nitya.accounter.web.client.ui.reports.VATSummaryReportAction;
import com.nitya.accounter.web.client.ui.reports.VATUncategorisedAmountsReportAction;
import com.nitya.accounter.web.client.ui.reports.VatExceptionDetailReportAction;
import com.nitya.accounter.web.client.ui.search.SearchInputAction;
import com.nitya.accounter.web.client.ui.settings.GeneralSettingsAction;
import com.nitya.accounter.web.client.ui.settings.InvoiceBrandingAction;
import com.nitya.accounter.web.client.ui.settings.JobListAction;
import com.nitya.accounter.web.client.ui.settings.MeasurementListAction;
import com.nitya.accounter.web.client.ui.settings.StockSettingsAction;
import com.nitya.accounter.web.client.ui.settings.UsersAction;
import com.nitya.accounter.web.client.ui.translation.TranslationAction;
import com.nitya.accounter.web.client.ui.vat.AdjustTAXAction;
import com.nitya.accounter.web.client.ui.vat.ETdsFillingAction;
import com.nitya.accounter.web.client.ui.vat.FileTAXAction;
import com.nitya.accounter.web.client.ui.vat.ManageTAXCodesListAction;
import com.nitya.accounter.web.client.ui.vat.NewTAXCodeAction;
import com.nitya.accounter.web.client.ui.vat.NewVatItemAction;
import com.nitya.accounter.web.client.ui.vat.PayTAXAction;
import com.nitya.accounter.web.client.ui.vat.ReceiveVATAction;
import com.nitya.accounter.web.client.ui.vat.TAXAgencyListAction;
import com.nitya.accounter.web.client.ui.vat.TDSAcknowledgmentAction;
import com.nitya.accounter.web.client.ui.vat.TDSChalanDetailsAction;
import com.nitya.accounter.web.client.ui.vat.TDSFiledDetailsAction;
import com.nitya.accounter.web.client.ui.vat.TDSForm16AAction;
import com.nitya.accounter.web.client.ui.vat.TaxHistoryAction;
import com.nitya.accounter.web.client.ui.vat.VatItemListAction;
import com.nitya.accounter.web.client.ui.vendors.BillsAction;
import com.nitya.accounter.web.client.ui.vendors.CashExpenseAction;
import com.nitya.accounter.web.client.ui.vendors.CreditCardExpenseAction;
import com.nitya.accounter.web.client.ui.vendors.DepositAction;
import com.nitya.accounter.web.client.ui.vendors.EnterBillsAction;
import com.nitya.accounter.web.client.ui.vendors.ExpenseClaimsAction;
import com.nitya.accounter.web.client.ui.vendors.ExpensesAction;
import com.nitya.accounter.web.client.ui.vendors.IssuePaymentsAction;
import com.nitya.accounter.web.client.ui.vendors.NewCashPurchaseAction;
import com.nitya.accounter.web.client.ui.vendors.NewCreditMemoAction;
...
import com.nitya.accounter.web.client.ui.vendors.Prepare1099MISCAction;
import com.nitya.accounter.web.client.ui.vendors.PurchaseOrderAction;
import com.nitya.accounter.web.client.ui.vendors.VendorPaymentsAction;
import com.nitya.accounter.web.client.ui.vendors.VendorPaymentsListAction;
import com.nitya.accounter.web.client.ui.vendors.VendorsHomeAction;
import com.nitya.accounter.web.client.ui.vendors.VendorsListAction;
...
public class MainFinanceWindow extends FlowPanel {
	...
	private void createControls() {
		...
		viewManager.createView(this, menubar.getStackPanel());
	...
	private void initializeActionsWithTokens() {
		...
		actions.put(PayRollReportActions
				.getPayTaxSummaryReportAction()
				.getHistoryToken(), PayRollReportActions
				.getPayTaxSummaryReportAction());
		...
		actions.put(PayRollActions.newPayTaxAction().getHistoryToken(),
				PayRollActions.newPayTaxAction());

		//NewConsultAction consultantAction = new NewConsultAction( "Consultant");
		//actions.put(consultantAction.getHistoryToken(), consultantAction);
		
		EmployeeTimeSheetAction timeSheetAction = new EmployeeTimeSheetAction();
		actions.put(timeSheetAction.getHistoryToken(),
				new EmployeeTimeSheetAction());
		
		ConsultantsDetailsList consultantDetails = new ConsultantsDetailsList();
		NewConsultantCenterViewAction newConsultantCenter = new NewConsultantCenterViewAction( consultantDetails);
		actions.put(newConsultantCenter.getHistoryToken(), new NewConsultantCenterViewAction(consultantDetails));

		NewConsultAction consultantAction = new NewConsultAction(false);
		consultantAction.setType(ClientItem.TYPE_SERVICE);
		consultantAction.setSubType(ClientItem.TYPE_CONSULTANT_PART);
		//consultantAction.setItemText("Testing");
		actions.put(consultantAction.getHistoryToken(), consultantAction);

		ConsultantCenterAction consultantCenterAction = new ConsultantCenterAction( "consultantCenter");
		actions.put(consultantCenterAction.getHistoryToken(), consultantCenterAction);
