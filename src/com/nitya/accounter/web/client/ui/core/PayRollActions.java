...
import com.nitya.accounter.web.client.ui.payroll.AttendanceManagementView;
import com.nitya.accounter.web.client.ui.payroll.AttendanceOrProductionTypeListView;
import com.nitya.accounter.web.client.ui.payroll.EmployeeGroupListDialog;
import com.nitya.accounter.web.client.ui.payroll.EmployeeListView;
import com.nitya.accounter.web.client.ui.payroll.NewClientAttendanceOrProductionDialog;
import com.nitya.accounter.web.client.ui.payroll.NewEmployeeGroupDialog;
import com.nitya.accounter.web.client.ui.payroll.NewEmployeeView;
import com.nitya.accounter.web.client.ui.payroll.NewPayHeadView;
import com.nitya.accounter.web.client.ui.payroll.NewPayRunView;
import com.nitya.accounter.web.client.ui.payroll.NewPayStructureView;
import com.nitya.accounter.web.client.ui.payroll.NewPayrollUnitDialog;
import com.nitya.accounter.web.client.ui.payroll.PayEmployeeView;
import com.nitya.accounter.web.client.ui.payroll.PayStructureListView;
import com.nitya.accounter.web.client.ui.payroll.PayTaxView;
import com.nitya.accounter.web.client.ui.payroll.PayheadListView;
import com.nitya.accounter.web.client.ui.payroll.PayrollUnitListView;
import com.nitya.accounter.web.client.ui.react.ReactBaseView;
...
public class PayRollActions extends Action {
	...
	private static final int NEW_PAY_TAX = 16;

	public static final int ATTENDANCE_MANAGEMENT = 15;
	private int type;
	...
	protected void showNewView() {
		...
		case ATTENDANCE_MANAGEMENT:
			view = new AttendanceManagementView();
			break;
		case NEW_PAY_STRUCTURE:
		...
		case NEW_PAY_TAX:
			view = new PayTaxView();
			/*
			 * view = new ReactBaseView<IAccounterCore>() { };
			 */
			break;	
		default:
			break;
	...
	public static PayRollActions newPayTaxAction() {
		return new PayRollActions(NEW_PAY_TAX);
	}
