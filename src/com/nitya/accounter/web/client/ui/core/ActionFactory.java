...
import com.nitya.accounter.web.client.ui.RemindersListAction;
import com.nitya.accounter.web.client.ui.banking.AccountRegisterAction;
import com.nitya.accounter.web.client.ui.banking.BankStatementAction;
import com.nitya.accounter.web.client.ui.banking.BankingHomeAction;
import com.nitya.accounter.web.client.ui.banking.BuyChecksAndFormsAction;
import com.nitya.accounter.web.client.ui.banking.CreditCardChargeAction;
import com.nitya.accounter.web.client.ui.banking.EnterPaymentsAction;
import com.nitya.accounter.web.client.ui.banking.ImportBankFilesAction;
import com.nitya.accounter.web.client.ui.banking.MakeDepositAction;
import com.nitya.accounter.web.client.ui.banking.MatchTrasactionsAction;
import com.nitya.accounter.web.client.ui.banking.NewReconcileAccountAction;
import com.nitya.accounter.web.client.ui.banking.PrintChecksAction;
import com.nitya.accounter.web.client.ui.banking.ReconciliationsListAction;
import com.nitya.accounter.web.client.ui.banking.ServicesOverviewAction;
import com.nitya.accounter.web.client.ui.banking.StatementImportViewAction;
import com.nitya.accounter.web.client.ui.banking.StatementReconcilationAction;
import com.nitya.accounter.web.client.ui.banking.SyncOnlinePayeesAction;
import com.nitya.accounter.web.client.ui.banking.WriteChecksAction;
import com.nitya.accounter.web.client.ui.combo.DropDownAction;
import com.nitya.accounter.web.client.ui.company.*;
import com.nitya.accounter.web.client.ui.customers.*;
import com.nitya.accounter.web.client.ui.fixedassets.DisposingRegisteredItemAction;
import com.nitya.accounter.web.client.ui.fixedassets.HistoryListAction;
import com.nitya.accounter.web.client.ui.fixedassets.NewFixedAssetAction;
...
import com.nitya.accounter.web.client.ui.fixedassets.SellingRegisteredItemAction;
import com.nitya.accounter.web.client.ui.fixedassets.SoldDisposedFixedAssetsListAction;
import com.nitya.accounter.web.client.ui.reports.BudgetOverviewReportAction;
import com.nitya.accounter.web.client.ui.reports.BudgetvsActualsAction;
import com.nitya.accounter.web.client.ui.reports.DepreciationSheduleAction;
import com.nitya.accounter.web.client.ui.reports.ECSalesListAction;
import com.nitya.accounter.web.client.ui.reports.ECSalesListDetailAction;
import com.nitya.accounter.web.client.ui.reports.InventoryDetailsAction;
import com.nitya.accounter.web.client.ui.reports.ItemActualCostDetailReportAction;
import com.nitya.accounter.web.client.ui.reports.JobActualDetailAction;
import com.nitya.accounter.web.client.ui.reports.MISC1099TransactionDetailAction;
import com.nitya.accounter.web.client.ui.reports.MostProfitableCustomersAction;
import com.nitya.accounter.web.client.ui.reports.ReportsHomeAction;
import com.nitya.accounter.web.client.ui.reports.ReverseChargeListAction;
import com.nitya.accounter.web.client.ui.reports.ReverseChargeListDetailAction;
...
import com.nitya.accounter.web.client.ui.reports.VaTItemDetailAction;
...
import com.nitya.accounter.web.client.ui.settings.AutomaticSequenceAction;
import com.nitya.accounter.web.client.ui.settings.ConversionBalancesAction;
import com.nitya.accounter.web.client.ui.settings.ConversionDateAction;
import com.nitya.accounter.web.client.ui.settings.CopyThemeAction;
import com.nitya.accounter.web.client.ui.settings.CustomThemeAction;
import com.nitya.accounter.web.client.ui.settings.DeleteThemeAction;
import com.nitya.accounter.web.client.ui.settings.GeneralSettingsAction;
import com.nitya.accounter.web.client.ui.settings.InviteUserAction;
...
import com.nitya.accounter.web.client.ui.vendors.EmployeeExpenseAction;
...
import com.nitya.accounter.web.client.ui.vendors.NewItemReceiptAction;
...
import com.nitya.accounter.web.client.ui.vendors.PreviousClaimAction;
import com.nitya.accounter.web.client.ui.vendors.PurchaseOrderAction;
import com.nitya.accounter.web.client.ui.vendors.RecordExpensesAction;
import com.nitya.accounter.web.client.ui.vendors.TDSPayAction;
import com.nitya.accounter.web.client.ui.vendors.TDSVendorsListAction;
...
import com.nitya.accounter.web.client.ui.win8.IPadMenuAction;
import com.nitya.accounter.web.client.ui.win8.Windows8MenuAction;
...
public class ActionFactory {
	...
	public static NewConsultAction getNewConsultantAction() {
		return new NewConsultAction();
	}

	public static NewConsultAction getNewConsultantAction(String quickAddText) {
		return new NewConsultAction(quickAddText);
	}

	public static NewConsultAction getNewConsultantAction(
			ClientItem customer,
			AccounterAsyncCallback<Object> callBackObject) {
		return new NewConsultAction(customer, callBackObject);
	}
	
	public static EmployeeTimeSheetAction getEmployeeTimeSheetAction() {
		return new EmployeeTimeSheetAction();
	}
	
	public static NewConsultantCenterViewAction getNewConsultantDetails(ConsultantsDetailsList details) {
		return new NewConsultantCenterViewAction(details);
	}
}
