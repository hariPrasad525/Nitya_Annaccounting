...
import com.nitya.accounter.web.client.ui.reports.AbstractReportView;
import com.nitya.accounter.web.client.ui.reports.PayHeadDetailReport;
import com.nitya.accounter.web.client.ui.reports.PayHeadSummaryReport;
import com.nitya.accounter.web.client.ui.reports.PaySheetReport;
import com.nitya.accounter.web.client.ui.reports.PaySlipDetailReport;
import com.nitya.accounter.web.client.ui.reports.PaySlipSummaryReport;
import com.nitya.accounter.web.client.ui.reports.PayTaxReportSummary;
...
public class PayRollReportActions extends Action {
	...
	public final static int PAY_TAX_SUMMARY_REPORT =6;
	...
	public String getText() {
		...
		case PAY_TAX_SUMMARY_REPORT:
			return messages2.payTaxSummaryReport();
		default:
			break;
		}
		return null;
	...
	protected void showNewReportView() {
		...
		case PAY_SHEET_REPORT:
			...
			break;
		case PAY_TAX_SUMMARY_REPORT:
			reportView = new PayTaxReportSummary();
			break;
		default:
			break;
		}
	...
	public String getHistoryToken() {
		...
		case PAY_TAX_SUMMARY_REPORT:
			return HistoryTokens.PAY_TAX_SUMMARY_REPORT;
		default:
			break;
		}
		return null;
	...
	public static PayRollReportActions getPayTaxSummaryReportAction() {
		return new PayRollReportActions(PAY_TAX_SUMMARY_REPORT);
	}
}
