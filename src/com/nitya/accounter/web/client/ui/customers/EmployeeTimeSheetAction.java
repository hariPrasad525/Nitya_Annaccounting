...
public class EmployeeTimeSheetAction extends Action<ClientEmployeeTimeSheet>{
	...
	public String getText() {
		...
		return messages2.employeeTimeSheet();
	}
	...
	private void runAsync(Object data, boolean isDependent) {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				EmployeeTimeSheetView view = GWT.create(EmployeeTimeSheetView.class);
				MainFinanceWindow.getViewManager().showView(view, data,
						isDependent, EmployeeTimeSheetAction.this);
			}
