...
public class HistoryTokens {
	...
	public static final String CLIENTPAYROLL = "clientPayroll";

	public static final String PAY_TAX_SUMMARY_REPORT = "payTaxSummaryReport";

	public static final String PAY_TAX = "PayTax";

	public static final String ITCONSULTANT = "itConsultant";

	public static final String CONSULTANTCENTER = "consultantCenter";

	public static final String NEW_CONSULTANT = "newConsultant";
	
	public static final String EMPLOYEE_TIME_SHEET = "employeeTimeSheet";
	
	public static final String NEW_CONSULTANT_CENTER = "newConsultantCenter";
