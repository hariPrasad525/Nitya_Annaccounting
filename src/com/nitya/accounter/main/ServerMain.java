...
import com.nitya.accounter.mobile.AccounterChatServer;
import com.nitya.accounter.mobile.AccounterMobileException;
import com.nitya.accounter.mobile.MobileServer;
...
public class ServerMain extends Main {
	...
	public static void main(String[] args) throws Exception {
		...
		JettyServer.start(ServerConfiguration.getMainServerPort(),
				...
				ServerConfiguration.getSslPort());
...
//				appender.setLayout(layout);
		...
		Logger.getLogger("com.nitya").setLevel(Level.INFO);
