...
import com.nitya.accounter.core.TransactionPayTAX;
...
public class PayTaxMigrator extends TransactionMigrator<PayTAX> {
	...
	public JSONObject migrate(PayTAX obj, MigratorContext context) throws JSONException {
		...
		external.put("com.nitya.accounter.shared.tax.PayTAX", jsonObject);
		...
		items.put("com.nitya.accounter.shared.tax.PayTAXItem", array);
