...
import com.nitya.accounter.core.TransactionCreditsAndPayments;
import com.nitya.accounter.core.TransactionPayBill;
...
public class PayBillMigrator extends TransactionMigrator<PayBill> {
	...
	public JSONObject migrate(PayBill obj, MigratorContext context) throws JSONException {
		...
		external.put("com.nitya.accounter.shared.vendor.PayBill", jsonObject);

		List<TransactionPayBill> transactionPayBill = obj.getTransactionPayBill();
		JSONArray payBillItems = new JSONArray();
		JSONObject items = new JSONObject();
		items.put("com.nitya.accounter.shared.vendor.PayBillItem", payBillItems);
		for (TransactionPayBill tBill : transactionPayBill) {
			...
			outter.put("com.nitya.accounter.shared.vendor.EnterBill", inter);
			...
			if (payBill != null) {
				...
				payBillOutter.put("com.nitya.accounter.shared.vendor.PayBill", payBillInter);
			...
			if (discountAccount != null) {
				...
				discountAccountOutter.put("com.nitya.accounter.shared.common.Account", discountAccountInner);
			...
			if (!transactionCreditsAndPayments.isEmpty()) {
				...
				acOut.put("com.nitya.accounter.shared.vendor.ApplyDebit", applyDebit);
				JSONArray applyDebitItems = new JSONArray();
				JSONObject acItems = new JSONObject();
				acItems.put("com.nitya.accounter.shared.vendor.ApplyDebitItem", applyDebitItems);
				for (TransactionCreditsAndPayments ac : transactionCreditsAndPayments) {
					...
					applyDebitItemJSON.put("@_lid", applyDebitItem);
					{
						...
						applyDebitOutter.put("com.nitya.accounter.shared.vendor.ApplyDebit", applyDebitInter);
					...
					}
					{
						...
						debitOutter.put("com.nitya.accounter.shared.vendor.VendorDebit", debitInter);
