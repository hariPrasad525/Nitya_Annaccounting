...
public class CustomerMigrator implements IMigrator<Customer> {
	...
	public JSONObject migrate(Customer obj, MigratorContext context) throws JSONException {
		...
		external.put("com.nitya.accounter.shared.customer.Customer", jsonObject);
		...
		if (priceLevel != null) {
			...
			plev.put("com.nitya.accounter.shared.customer.PriceLevel", json);
		...
		if (salesPerson != null) {
			...
			inter.put("com.nitya.accounter.shared.customer.SalesPerson", outter);
		...
		if (customerGroup != null) {
			JSONObject inter = new JSONObject();
			JSONObject outter = new JSONObject();
			inter.put("com.nitya.accounter.shared.customer.CustomerGroup", outter);
		...
		if (obj.getContacts() != null && !obj.getContacts().isEmpty()) {
			...
			for (Contact contact : obj.getContacts()) {
				...
				if (contact.isPrimary()) {
					...
					primaryContact.put("com.nitya.accounter.shared.common.Contact", jsonIn);
