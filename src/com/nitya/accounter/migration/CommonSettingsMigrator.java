	...
	public JSONObject migrate(CompanyPreferences obj, MigratorContext context)
		...
		JSONObject object = new JSONObject();
		{
			...
			Company company = context.getCompany();
			{
				...
				accountPayable.put(
						"com.nitya.accounter.shared.common.Account", json);
			...
			}
			{
				...
				if (salariesPayableAccount != null) {
					...
					JSONObject json = new JSONObject();
					salariesPayable
							.put("com.nitya.accounter.shared.common.Account",
									json);
					String parentLocalID = context.getLocalIdProvider()
			...
			}
			{
				...
				JSONObject json = new JSONObject();
				taxFiled.put("com.nitya.accounter.shared.common.Account",
						json);
				String parentLocalID = context.getLocalIdProvider()
			...
			if (measurement != null) {
				...
				outter.put(
						"com.nitya.accounter.shared.inventory.Measurement",
						inter);
			...
			if (warehouse != null) {
				JSONObject inter = new JSONObject();
				JSONObject outter = new JSONObject();
				outter.put("com.nitya.accounter.shared.inventory.Warehouse",
						inter);
				String localId = context.getLocalIdProvider().getOrCreate(
						warehouse);
