...
import com.nitya.accounter.core.AttendanceManagementItem;
...
public class PayRunMigrator implements IMigrator<PayRun> {
	...
	public JSONObject migrate(PayRun obj, MigratorContext context) throws JSONException {
		...
		jsonObject.put("@class", "com.nitya.accounter.shared.payroll.PayRun");
		...
		for (EmployeePaymentDetails item : payEmployees) {
			...
			payRunItem.put("@class", "com.nitya.accounter.shared.payroll.PayRunItem");
			...
			if (!items.isEmpty()) {
				...
				for (PayStructureItem payStructureItem : items) {
					...
					empPayRunItem.put("@class", "com.nitya.accounter.shared.payroll.PayStructureItem");
