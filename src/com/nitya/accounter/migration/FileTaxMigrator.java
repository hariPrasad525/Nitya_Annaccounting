...
import com.nitya.accounter.migration.MigratorContext.Tuple;
...
public class FileTaxMigrator extends TransactionMigrator<TAXReturn> {
	...
	public JSONObject migrate(TAXReturn obj, MigratorContext context)
		...
		external.put("com.nitya.accounter.shared.tax.FileTax", jsonObject);
		...
		items.put("com.nitya.accounter.shared.tax.FileTaxItem", fileTaxItems);
