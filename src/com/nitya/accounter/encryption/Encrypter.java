package com.nitya.accounter.encryption;
...
import com.nitya.accounter.core.*;
			...
			for (Class<?> cls : classes) {
				...
				try {
					...
					for (Object o : list) {
						...
						if (o instanceof com.nitya.accounter.core.Transaction) {
							com.nitya.accounter.core.Transaction t = (com.nitya.accounter.core.Transaction) o;
